...
from apps.core.models import Post, Comment, Notification, ThreadModel, MessegeModel
from apps.accounts.models import Profile
from apps.core.forms import CommentModelForm, PostModelForm, ThreadForm, MessegeForm
